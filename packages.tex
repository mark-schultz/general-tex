...
\newcommand{\Re}{\RR\cup\Bqty{\infty}}
\newcommand{\RE}{\RR\cup\Bqty{\pm\infty}}
\newcommand{\E}{\mathbb{E}}
\newcommand{\H}{\mathbb{H}} %% Complex Upper-Half Plane
...
\renewcommand{\Hh}{\mathcal{H}}  % old \H{x} is an x with a weird umlaut in text mode
...
\newcommand{\Bb}{\mathcal{B}}  	% Borel Algebra
\newcommand{\oldL}{\L}          % Some accented character
\renewcommand{\Ll}{\mathcal{L}}	% Lesbegue Algebra
\newcommand{\Cc}{\mathcal{C}}    % Cantor Set
\newcommand{\Ii}{\mathcal{I}}		% Lebesgue Integrable functions.
\newcommand{\Aa}{\mathcal{A}}	  % Functions that separate points
\newcommand{\oldO}{\O} 					% 0 with line through it, ``fat emptyset''
\renewcommand{\Oo}{\mathcal{O}}	% Integer ring of number field
